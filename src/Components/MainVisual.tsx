...
const MainVisual: React.FC = () => {
    return (
        <div className='sm:px-28 px-5 overflow-hidden'>
            <div className="sm:mt-14 sm:relative sm:h-[830px] w-full xl:w-3/4">
                <div className='flex sm:flex-col flex-col-reverse gap-5'>
                    <div className='flex gap-10 flex-col sm:flex-row'>
                        ...
                        <button className='rounded-full bg-white text-purple shadow-custom-purple py-2 px-4 w-2/3 mx-auto sm:w-52 sm:mx-0'>LIVE-PRE-SALE</button>
                        <button className='rounded-full bg-white text-purple shadow-custom-purple py-2 px-4 w-2/3 mx-auto sm:w-52 sm:mx-0'>LITE-PAPER</button>
                    </div>
                    <div className='mt-5 flex sm:justify-between w-full sm:relative sm:flex-row flex-col gap-5'>
                        <div className='text-left w-full'>
                            ...
                            <div className='font-serif text-2xl text-darkPurple mb-6' style={{ fontFamily: "sans-serif" }}>
                ...
                <div className='sm:absolute sm:bottom-0 sm:-right-48 w-full'>
                    <img
